...
let defaultProducts = [
    { id: "P01", name: "Dior Sauvage Eau De Parfum", price1: 650000, price2: 950000, price3: 2850000, image: "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80", brand: "Dior", sex: "nam" },
    { id: "P02", name: "Bleu De Chanel", price1: 750000, price2: 1100000, price3: 3200000, image: "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=400&q=80", brand: "Chanel", sex: "nam" },
    { id: "P03", name: "Tom Ford Oud Wood", price1: 1200000, price2: 1800000, price3: 5500000, image: "https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?auto=format&fit=crop&w=400&q=80", brand: "Tom Ford", sex: "unisex" },
    { id: "P04", name: "YSL Y Eau De Parfum", price1: 600000, price2: 850000, price3: 2600000, image: "https://images.unsplash.com/photo-1615634260167-c8cd6d5104ce?auto=format&fit=crop&w=400&q=80", brand: "YSL", sex: "nam" },
    { id: "P05", name: "Creed Aventus", price1: 1800000, price2: 2500000, price3: 7200000, image: "https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?auto=format&fit=crop&w=400&q=80", brand: "Creed", sex: "nam" },
    { id: "P06", name: "Versace Eros", price1: 450000, price2: 650000, price3: 1800000, image: "https://images.unsplash.com/photo-1595425970377-c9703c486558?auto=format&fit=crop&w=400&q=80", brand: "Versace", sex: "nam" },
    { id: "P07", name: "Jo Malone English Pear", price1: 850000, price2: 1200000, price3: 0, image: "https://images.unsplash.com/photo-1594035910387-fea47794261f?auto=format&fit=crop&w=400&q=80", brand: "Jo Malone", sex: "nữ" },
    { id: "P08", name: "Gucci Bloom", price1: 750000, price2: 1050000, price3: 3100000, image: "https://images.unsplash.com/photo-1615634260167-c8cd6d5104ce?auto=format&fit=crop&w=400&q=80", brand: "Gucci", sex: "nữ" }
];
...
// ==========================================
const renderProducts = (dataToRender = products, isSearching = false) => {
    const list = document.getElementById('product-list');
    const loadMoreBtn = document.getElementById('load-more-container');
    
    // Cập nhật số lượng đếm
    document.getElementById('product-count').innerText = `${dataToRender.length} ${t('products')}`;
    ...
    let itemsToShow = isSearching ? dataToRender : dataToRender.slice(0, displayLimit);
    ...
    if (!isSearching && displayLimit < dataToRender.length) {
...
const downloadSampleExcel = () => {
    const data = [
        { id: "P01", brand: "Dior", name: "Dior Sauvage EDP", sex: "nam", "Price 1": 650000, "Price 2": 950000, "Price 3": 2850000, "Price 4": 0, image: "https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=400&q=80" },
        { id: "P05", brand: "Gucci", name: "Gucci Bloom", sex: "nữ", "Price 1": 750000, "Price 2": 1050000, "Price 3": 3100000, "Price 4": 0, image: "https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?auto=format&fit=crop&w=400&q=80" },
        { id: "P06", brand: "Jo Malone", name: "English Pear & Freesia", sex: "unisex", "Price 1": 850000, "Price 2": 1200000, "Price 3": 0, "Price 4": 0, image: "https://images.unsplash.com/photo-1595425970377-c9703c486558?auto=format&fit=crop&w=400&q=80" }
    ];
        ...
        try {
            ...
            if (json.length > 0) {
                products = json.map(row => ({
                    id: row.id ? String(row.id) : `P${Math.floor(Math.random()*10000)}`,
                    brand: row.brand || 'Khác',
                    name: row.name || 'Sản phẩm không tên',
                price1: Number(row['Price 1']) || 0,
                price2: Number(row['Price 2']) || 0,
                price3: Number(row['Price 3']) || Number(row['Price 4']) || 0,
                sex: row.sex || 'unisex',
